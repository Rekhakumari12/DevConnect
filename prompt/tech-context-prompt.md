...
Business context defines _what must happen_.
Technical context explains _how it is achieved_ and _why this approach was chosen_.

If a technical decision cannot be justified without business context,
you MUST refer to `/context/business-domain-context.md`.
...
Explicitly align technical understanding with `/context/business-domain-context.md`:
...
Generate a `technical-context.md` file with the following structure:
...
2. Check for `/context/business-domain-context.md`
