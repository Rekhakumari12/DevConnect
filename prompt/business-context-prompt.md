...
extracting business intent through **dynamic, repository-driven questions** and product-requirement-doc.md.
...
Code shows _what exists_.
Business context explains _why it exists_.
...
- What the system appears to _do_
...
Question categories should _emerge naturally_ from the repo, such as:
...
Generate a `business-domain-context.md` file structured as:
